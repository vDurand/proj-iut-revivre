...
?>
            <div id="awaiting-form-employe" style="display:none;">
                <form method="POST" action="postContact.php">
                    ...
                    echo "<input type=\"hidden\" name=\"connum\" value=\"".$num."\">
...
?>
        ...
        <?php
                    while($data = mysqli_fetch_assoc($query)){
        ?>
                        <tr data-channum="<?php echo $data["PER_Num"]; ?>">
...
<script type="text/javascript">
    $(document).ready(function(){
        $("#addEmploye").on("click", function(){
            $("#employe-list").hide();
            $("#awaiting-form-employe").css("display","block");
            $(this).hide();
        });

        $("#cancelAddEmploye").on("click", function(){
            $("#employe-list").show();
            $("#awaiting-form-employe").hide();
            $("#addEmploye").show();
        });
        ...
        $("#employe-list table tr").on("click", function(){
        ...
        $("#chantier-list table tr").on("click", function(){
