		...
		<div class="owl-carousel">
		  <div id="plInsertion" class="planning">
			...
			<?php
				...
				{
					echo "<h2>Aucun planning insertion n'est disponible</h2>";
				}
			?>
		  </div>
		  <div id="plOccupationnel" class="planning">
			...
			<?php
				...
				{
					echo "<h2>Aucun planning occupationnel n'est disponible</h2>";
				}
			?>
		  </div>
		  <div id="plStagiaire" class="planning">
			...
			<?php
				...
				{
					echo "<h2>Aucun planning stagiaire n'est disponible</h2>";
				}
			?>
		  </div>
		</div>
