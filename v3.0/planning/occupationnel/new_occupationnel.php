	...
	<div class="ScrollFrame">
		<div class="planningTable">
			<table id="insertionTableau">
				<thead>
					<?php
						echo '<th id="firstColumn"><input name="color" id="color" type="color" style="margin: 0 5px;" value="#228B22" onchange="changeCouleur()"/></th>';
						for($x=0; $x<$nombreEncadrant; $x++)
						{
							echo'<th>
		...
		<table style="margin:10px auto 0 auto;">
			<tr>
				<td>
					...
					<input type='hidden' id="couleur" name='couleur' value='#228B22'>
				</td>
